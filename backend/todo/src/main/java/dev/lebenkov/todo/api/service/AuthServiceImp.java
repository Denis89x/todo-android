...
import dev.lebenkov.todo.api.security.JwtUtil;
import dev.lebenkov.todo.api.util.exception.AccountAlreadyExistsException;
import dev.lebenkov.todo.api.util.exception.AccountNotFoundException;
...
import dev.lebenkov.todo.store.repository.TokenRepository;
...
public class AuthServiceImp implements AuthService {
    ...
    public void revokeAllUserTokens(Account account) {
        var validUserTokens = tokenRepository.findByAccountIdAndExpiredIsFalseAndRevokedIsFalse(account.getId());
